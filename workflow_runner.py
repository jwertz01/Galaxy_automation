...
def _launch_workflow(galaxy_host, api_key, workflow, upload_history, upload_input_files_map, genome, library_list_mapping, library_datasets, sample_name, result_dir ):
    ...
    try:
        ...
        history = history_client.update_history(history['id'], annotation="Generated by workflow automation. Workflow name = %s. Upload history= %s" % (workflow['name'], upload_history['name']), tags=(upload_history['name']))
